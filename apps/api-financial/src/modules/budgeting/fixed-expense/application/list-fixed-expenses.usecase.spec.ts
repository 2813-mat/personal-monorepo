...
describe('ListFixedExpensesUseCase', () => {
  it('repassa year/month ao repositório e devolve status pago/pendente', async () => {
    const views: FixedExpenseView[] = [
      { id: 'f1', label: 'Aluguel', value: 2000, dueDay: 5, categorySlug: 'moradia', memberId: null, paidThisMonth: true },
      { id: 'f2', label: 'Internet', value: 100, dueDay: 10, categorySlug: 'moradia', memberId: null, paidThisMonth: false },
    ];
