...
@Component({
    ...
    <aside class="sb">
      <div class="sb-brand">
        ...
        <div class="sb-brand-info">
          <div class="sb-brand-name">Caixa Família</div>
  ...
  styles: [`
    ...
    .sb-brand-name {
      font-size: 13px; font-weight: 600; letter-spacing: -0.1px; color: var(--ink-1);
    }
    .sb-brand-sub {
    ...
    .sb-foot-name { font-size: 11.5px; color: var(--ink-1); font-weight: 500; }
    .sb-foot-role { font-size: 10px; color: var(--ink-4); }
  `],
})
